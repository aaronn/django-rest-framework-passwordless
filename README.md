[![Build Status](https://travis-ci.org/aaronn/django-rest-framework-passwordless.svg?branch=master)](https://travis-ci.org/aaronn/django-rest-framework-passwordless)
